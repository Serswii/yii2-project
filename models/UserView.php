...
class UserView extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['confirmed_at', 'blocked_at', 'created_at', 'updated_at', 'flags', 'last_login_at', 'status', 'id_organization', 'access_token'], 'integer'],
            [['username', 'email', 'unconfirmed_email', 'name_org', 'fio'], 'string', 'max' => 255],
